"""BUP-ST20 annotation pkl을 YOLO Detection bbox 라벨로 순차 변환.

주의:
- 공식 배포처에서 받은 신뢰할 수 있는 pickle 파일에만 사용.
- instance_mask는 YOLO Detection 학습에 저장하지 않음.
- bbox 형식은 공식 문서의 [x, y, width, height]를 사용.
"""

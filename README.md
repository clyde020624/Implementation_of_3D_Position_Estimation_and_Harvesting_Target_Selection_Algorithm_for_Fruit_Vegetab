...
> **문서 범위:** 연구 내용과 보고된 실험 결과를 소개하는 README이다. 코드 구조·설치·실행 방법은 공개용 코드 정리 후 별도로 보완한다.

[01. 연구 요약](#summary) · [02. 문제 정의](#question) · [03. 데이터셋](#dataset) · [04. 연구 방법](#method) · [05. 평가 방법](#evaluation)  
[06. 위치 추정 결과](#localization-results) · [07. 선정 결과](#selection-results) · [08. 선정 특성](#selection-characteristics) · [09. 민감도·보강 분석](#supplementary)  
[10. 결론](#conclusion) · [11. 한계·향후 연구](#limitations) · [12. 논문 정보·참고문헌](#references)
...
논문 수치는 공유 연구 원고를, 구성요소별 비교·민감도·선정 특성의 상세 수치는 기존 실험 기록을 기준으로 정리하였다. 최대 오차 진단과 대표 사례 수치는 추가 분석 및 최종 내보내기 결과 요약에 따른다.

이 문서 패키지는 README와 연구 결과 그림을 포함하며 **전체 실험 코드·데이터셋 원본·학습 가중치를 포함하지 않는다.** 공개 저장소에 사용할 자료의 이용·재배포 조건과 최종 코드 라이선스는 별도로 확인해야 한다.
